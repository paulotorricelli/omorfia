...
function preencherCamposModal(typeItem, dados) {
  switch (typeItem) {
    ...
    case "produto":
      ...
      break;
    case "despesa":
      $("#input-id-modal").val(dados.id_despesa);
      $("#input-valor-modal").val(dados.valor);
      $("#input-descricao-modal").val(dados.descricao);
      $("#input-categoria-modal").val(dados.id_categoria);
      $("#input-repetir-modal").val(dados.repetir);
      $("#input-status-modal").val(dados.status);
      $("#input-data-despesa-modal").val(dados.data_despesa);
      $("#input-despesa-fixa-modal").val(dados.despesa_fixa);
      $("#input-data-criacao").html(dateFormat(dados.data_criacao));
      $("#input-data-modificacao").html(dateFormat(dados.data_modificacao));
      break;
    default:
