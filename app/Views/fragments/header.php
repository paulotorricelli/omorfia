...
<html>
    ...
    <body class="hold-transition sidebar-mini layout-footer-fixed layout-fixed layout-navbar-fixed sidebar-collapse">
    <div class="wrapper">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                ...
                <a href="<?= base_url() ?>/saml?slo" class="dropdown-item dropdown-footer">
                Sair
                </a>
            </div>
            </li>
