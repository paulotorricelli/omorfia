            <footer class="main-footer">
                <small>
                    <div class="float-right d-none d-sm-inline"> Omorfiá | Estética personalizada</div>
                    <strong> &copy; <a href="https://omorfiaestetica.com.br/" target="_blank"> Omorfiá Estética</a></strong>
                </small>
                ...
                <script src="<?= base_url() ?>/resources/plugins/chart.js/Chart.min.js"></script><!-- ChartJS -->
                <script src="<?= base_url() ?>/resources/plugins/toastr/toastr.min.js"></script><!-- Toastr -->
